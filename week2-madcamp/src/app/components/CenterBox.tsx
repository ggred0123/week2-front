...
interface CenterBoxProps {
  color: string; // 배경 색상
  icon: "meet" | "exercise" | "drink" | "study"; // 아이콘 종류
  text: string; // 문구
}
...
const Icons = {
  meet: (
    ...
    style={{
      ...
      top: '1px',          // 위로 10px 이동
      left: '1px',          // 왼쪽으로 5px 이동
    }}
    >
      <g clipPath="url(#clip0_49_225)">
        <path
          d="M14.6389 2.72143C14.2842 2.35644 13.8631 2.0669 13.3996 1.86935C12.9361 1.67181 12.4392 1.57013 11.9375 1.57013C11.4358 1.57013 10.939 1.67181 10.4755 1.86935C10.0119 2.0669 9.59082 2.35644 9.23612 2.72143L8.50001 3.47858L7.7639 2.72143C7.04745 1.98451 6.07573 1.57051 5.06251 1.57051C4.0493 1.57051 3.07758 1.98451 2.36112 2.72143C1.64467 3.45836 1.24217 4.45784 1.24217 5.5C1.24217 6.54217 1.64467 7.54165 2.36112 8.27858L3.09723 9.03572L8.50001 14.5929L13.9028 9.03572L14.6389 8.27858C14.9938 7.91375 15.2753 7.48059 15.4673 7.00383C15.6594 6.52707 15.7582 6.01607 15.7582 5.5C15.7582 4.98394 15.6594 4.47294 15.4673 3.99618C15.2753 3.51942 14.9938 3.08626 14.6389 2.72143Z"
          fill="white"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
...
export default function CenterBox({ color, icon, text }: CenterBoxProps) {
  return (
    <div
    ...
    >
      ...
      <div
        className="absolute"
        style={{
          width: "70px", // 아이콘 컨테이너 크기
          height: "70px",
          borderRadius: "12px",
          background: color,
          boxShadow: "0px 8px 24px 0px rgba(0, 0, 0, 0.1)", // 그림자 조정
          top: "30px", // 상단 위치 (위로 10px 더 올림)
          left: "-145px", // 수평 중앙 정렬
          display: "flex",
      ...
      <p
        style={{
          position: "absolute",
          top: "45px",
          left: "-55px", // 텍스트 위치를 아이콘 아래로 이동
          color: "#333",
          fontFamily: "Heebo, sans-serif",
          fontSize: "25px", // 텍스트 크기
          fontWeight: 700,
          textAlign: "center",
