...
export default function Information() {
  return (
    <div style={{ background: '#FEFEFE' }} className="min-h-screen bg-white relative">
      {/* 배경 원 */}
      <div
        style={{
          width: '1009px',
          ...
          flexShrink: 0,
          borderRadius: '50%',
          background: 'linear-gradient(135deg, #1FF7FD -57.3%, #B33BF6 51.62%, #FF844C 101.62%, #FF844B 130.58%)',
          position: 'absolute',
          top: '-754px',
          left: '50%',
      ...
      <div
        style={{
          width: '400px',
          height: '67px',
          color: '#40282E', // 텍스트 색상 조정
          textAlign: 'center',
          fontFamily: 'ABeeZee, sans-serif',
          fontSize: '40px', // 글자 크기 조정
          fontStyle: 'normal',
          fontWeight: 400,
          lineHeight: '38px', // 줄 높이 조정
          letterSpacing: '-0.408px', // 글자 간격 조정
          position: 'absolute',
          top: '360px', // 텍스트 위치
          left: '50%',
          transform: 'translateX(-50%)',
          zIndex: 4, // 텍스트가 항상 위에 표시
        }}
      >
        Welcome<br />Sanggeun Oh
      </div>
      ...
      <div
        style={{
          ...
          zIndex: 3, // 박스를 가장 앞에 표시
        }}
      >
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: '1fr 1fr', // 두 열로 정렬
            gap: '80px', // 각 항목 간 간격
            justifyContent: 'center', // 수평 가운데 정렬
            alignContent: 'center', // 수직 가운데 정렬
            color: '#40282E', // 텍스트 색상
            fontFamily: 'ABeeZee, sans-serif',
            fontSize: '20px', // 텍스트 크기
            fontStyle: 'normal',
            fontWeight: 400,
            lineHeight: '18px', // 줄 높이
            letterSpacing: '-0.078px', // 글자 간격
            paddingTop: '8%', // 특정 위치로 배치하려는 경우
            paddingLeft: '11%',
          }}
        >
            {/* 첫 번째 행 */}
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                {/* 건물 아이콘 */}
                <path d="M12 11C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9C11.4477 9 11 9.44772 11 10C11 10.5523 11.4477 11 12 11Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6 17V17.01M6 13V13.01M18 17V17.01M18 13V13.01M22 20V8H18L12 4L6 8H2V20C2 20.5304 2.21071 21.0391 2.58579 21.4142C2.96086 21.7893 3.46957 22 4 22H20C20.5304 22 21.0391 21.7893 21.4142 21.4142C21.7893 21.0391 22 20.5304 22 20Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M14 22V17C14 16.4696 13.7893 15.9609 13.4142 15.5858C13.0391 15.2107 12.5304 15 12 15C11.4696 15 10.9609 15.2107 10.5858 15.5858C10.2107 15.9609 10 16.4696 10 17V22" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 22 20" fill="none">
                ...
                <span style={{ marginLeft: '10px' }}>캠프중</span>
            </div>

            {/* 네 번째 행 */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="21" viewBox="0 0 24 16" fill="none">
                ...
                <span style={{ marginLeft: '7px' }}>전산학부</span>
            </div>
        </div>
      </div>

      {/* "Recommended for You" 텍스트 */}
      <div
        style={{
          width: '300px',
          height: '28px',
          color: '#181D2D', // 텍스트 색상 조정
          textAlign: 'center',
          fontFamily: '"Product Sans", sans-serif',
          fontSize: '27px', // 글자 크기 조정
          fontWeight: 400,
          lineHeight: '25.874px',
          position: 'absolute',
          top: '1020px', // 텍스트 위치
